# Archived discrete full-table CROWN results

These `aprev_*_crown_results.json` files are from earlier full-table discrete
CROWN runs (TIMEOUT / UNSAT heavy). They are **orphaned** for the TACAS discrete
